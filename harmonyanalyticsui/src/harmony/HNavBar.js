      ...
      <Navbar collapseOnSelect expand="lg" bg="dark" variant="dark" sticky="top">
        ...
        <Navbar.Collapse id="basic-navbar-nav">
          <Nav className="mr-auto">
            <Nav.Link eventKey={1.12} href="/">Validators</Nav.Link>
            <Nav.Link eventKey={1.11} href="/account">My Account</Nav.Link>
            <Nav.Link eventKey={1.12} href="/networkEvents">Network</Nav.Link>
          </Nav>
        </Navbar.Collapse>
      </Navbar>
    );
